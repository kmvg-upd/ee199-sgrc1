...
working_path = r"C:\Users\ferre\OneDrive\Documents\Thesis Files\LV Feeder\CM4"
...
with open(working_path + r"\BusCombi.csv", "r") as f1,     open(working_path + r"\PVCombi.csv", "r") as f2,     open(working_path + r"\NMCombi.csv", "r") as f3:
    ...
    for line_id, (line1, line2, line3) in enumerate(zip(f1, f2, f3)):
        ...
        # Add meter monitors
        dssText.Command = r"Redirect '.\Monitor C4.txt'"
        ...
        # Export monitor data
        dssText.Command = r"Redirect '.\Export Monitor C4.txt'"
