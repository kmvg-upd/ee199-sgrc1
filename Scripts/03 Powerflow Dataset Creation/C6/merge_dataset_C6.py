...
Path(r"C:\Users\kaira\Documents\00_UP\04 Fourth Year\Second Sem\EE 199\Simulations - CM6\Merged_Datasets").mkdir(parents=True, exist_ok=True)
...
for sim in sim_subfolders:
    ...
    for file in queue: 
        ...
        if count == 3080:
            ...
            trans_df.to_csv(r'C:\Users\kaira\Documents\00_UP\04 Fourth Year\Second Sem\EE 199\Simulations - CM6\Merged_Datasets\{}.csv'.format(dataset), index=None)
            rows = []
            count = 0
