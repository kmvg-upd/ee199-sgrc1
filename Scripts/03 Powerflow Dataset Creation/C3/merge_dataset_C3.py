...
Path(r"C:\Users\kaira\Documents\00_UP\04 Fourth Year\Second Sem\EE 199\Simulations - CM3\Merged_Datasets").mkdir(parents=True, exist_ok=True)

filepath = r"C:\Users\kaira\Documents\00_UP\04 Fourth Year\Second Sem\EE 199\Simulations - CM3"
...
# Create column names
fields = ['cm_1_power', 'cm_2_power', 'cm_3_power', 'cm_4_power', 'cm_5_power', 
...
for sim in sim_subfolders:
    ...
    for file in queue: 
        ...
        if count == 3080:
            ...
            trans_df.to_csv(r'C:\Users\kaira\Documents\00_UP\04 Fourth Year\Second Sem\EE 199\Simulations - CM3\Merged_Datasets\{}.csv'.format(dataset), index=None)
            rows = []
            count = 0
