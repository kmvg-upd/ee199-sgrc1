...
Path(r"C:\Users\kaira\Documents\00_UP\04 Fourth Year\Second Sem\EE 199\Simulations - CM1\Merged_Datasets").mkdir(parents=True, exist_ok=True)
...
# Create column names
fields = ['cm_1_power', 'cm_2_power', 'cm_3_power', 'cm_4_power', 'cm_5_power', 'cm_6_power', 'cm_7_power', 'cm_8_power',
            'cm_9_power', 'cm_10_power', 'cm_11_power', 'cm_12_power', 'cm_13_power', 'cm_14_power', 'cm_15_power', 'cm_16_power',
            'cm_17_power', 'cm_18_power', 'cm_19_power', 'cm_20_power', 'cm_21_power', 'cm_22_power', 'cm_23_power', 'cm_24_power',
...
for sim in sim_subfolders:
    ...
    for file in queue: 
        ...
        if count == 3080:
            ...
            trans_df.to_csv(r'C:\Users\kaira\Documents\00_UP\04 Fourth Year\Second Sem\EE 199\Simulations - CM1\Merged_Datasets\{}.csv'.format(dataset), index=None)
            rows = []
            count = 0
